...
public class Actor extends Object
    ...
    private static ImageStock getImageStockInstance()
        ...
        if (image_stock == null)
            {
            ImageStock main_stock = AppRuntime.getCurrentImageStock();
    ...
    public Actor()
        ...
        grid_space = 40;
        name = "Node";
face_item = getImageStockInstance().requestImageItem(AppRuntime
...
face_item = getImageStockInstance().requestImageItem(AppRuntime
    ...
    public void setFace(String tmp_face_source)
        ...
        if (tmp_face_source == null || tmp_face_source.length() == 0
            ...
            {
            tmp_face_source = AppRuntime.getDefaultNodeFaceSource();
            }
face_item = getImageStockInstance().requestImageItem(tmp_face_source);
    ...
    private boolean getSTGEnabled()
        ...
        try
            {
            value = AppRuntime.getCurrentFullNet().getArea().isSTGEnabled();
            } catch (Exception e) {
